...
//<!--热度、评论-->
		...
		$("#hot_" + id).click(function() {
			$("#say1_" + id).slideUp();
			$("#hot1_" + id).slideToggle();
		});
		$("#say_" + id).click(function() {
			$("#hot1_" + id).slideUp();
        ...
        <div>
          <table>
            <tr>
              ...
              <!--关注、取消关注-->
               <td><button class="btn button1_${param.id} btn-mini" id="show_${param.id }" ><i class="icon-plus button1_${param.id}"></i></button>
              <button class="btn button2_${param.id} btn-mini" id="hide_${param.id }"><i class="icon-minus"></i></button></td>
            </tr>
          </table>
        </div>
        <div>
...
<!--            <button class="btn btn-mini" id="hot_${param.id }">热度</button>       -->   <!-- 删除该功能 -->
              <button class="btn btn-mini" id="say_${param.id }">评论</button>
      ...
      <!--***************************************热度列表***************************************-->
      <!-- 时间不够，实现有点麻烦，不弄了 -->
      <div id="hot1_${param.id }" style="background-color:#FFF" class="div1">
      ...
      <!--***************************************评论列表***************************************-->
      <div id="say1_${param.id }" style="background-color:#ccc" class="div1">
